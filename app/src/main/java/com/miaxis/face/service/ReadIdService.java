 ...
 * helper methods.
 */
public class ReadIdService extends IntentService {
    // TODO: Rename actions, choose action names that describe tasks that this
    // IntentService can perform, e.g. ACTION_FETCH_NEW_ITEMS
    private static final String ACTION_READ_ID = "com.miaxis.face.service.action.ReadId";
    ...
    public static void startActionReadId(Context context) {
        Intent intent = new Intent(context, ReadIdService.class);
     ...
     * parameters.
     */
    private void handleActionReadId() {
    }
